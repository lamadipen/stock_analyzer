...
class FinancialHighlightsContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        // ---- criteria ----
        const Text('Revenue/Sales: Consistently increasing over the last 5-10 years.'),
        const SizedBox(height: 8),
        const Text('Net Income: Consistently increasing over the last 5-10 years.'),
        const SizedBox(height: 8),
        const Text('Cash Flow from Operations: Consistently increasing over the last 5-10 years.'),
        ...
        const Text('Profitability Metrics', style: TextStyle(fontWeight: FontWeight.w600)),
        const SizedBox(height: 8),
        ...
        const Text('Conservative Debt', style: TextStyle(fontWeight: FontWeight.w600)),
        const SizedBox(height: 8),
        ...
        Container(
          ...
          child: Column(
            ...
            children: const [
              ...
              SizedBox(height: 4),
              Text('EBITDA = Earnings Before Interest, Taxes, Depreciation & Amortization'),
              SizedBox(height: 4),
              Text('Debt Servicing ratio = net interest expense / cash flow from operations * 100'),
              SizedBox(height: 8),
              Text(
        ...
        const Text('Debt & Solvency References:', style: TextStyle(fontWeight: FontWeight.w600)),
        const SizedBox(height: 8),
        Wrap(
          spacing: 8,
          runSpacing: 8,
        ...
        const Text('Income Statement References:', style: TextStyle(fontWeight: FontWeight.w600)),
        const SizedBox(height: 8),
        Wrap(
          spacing: 8,
          runSpacing: 8,
        ...
        const Text('Profitability References:', style: TextStyle(fontWeight: FontWeight.w600)),
        const SizedBox(height: 8),
        Wrap(
          spacing: 8,
          runSpacing: 8,
